/*! For license information please see main.f666ead9.js.LICENSE.txt */
!(function () {
	var e = {
			463: function (e, n, t) {
				'use strict';
						...
						if (null === a) Wr(e, n, r, Yn, t), Mn(e, r);
							...
							(function (e, n, t, r, a) {
								switch (n) {
									...
									case 'gotpointercapture':
										return (l = a.pointerId), Ln.set(l, jn(Ln.get(l) || null, e, n, t, r, a)), !0;
								}
								return !1;
							})(a, e, n, t, r)
						)
				...
				function ja(e, n, t) {
					...
					t
						? ((e = Fa(e, n, Oa)), (r.__reactInternalMemoizedMergedChildContext = e), Ca(Ta), Ca(Pa), _a(Pa, e))
						: Ca(Ta),
						_a(Ta, t);
				}
				var Ia = null,
				...
				function hl(e, n, t) {
					...
					return (
						'object' === typeof l && null !== l
							? (l = Za(l))
							: ((a = za(n) ? Oa : Pa.current),
							  (l = (r = null !== (r = n.contextTypes) && void 0 !== r) ? Ra(e, a) : Na)),
						(n = new n(t, l)),
				...
				function vl(e, n, t, r) {
					...
					'object' === typeof l && null !== l
						? (a.context = Za(l))
						: ((l = za(n) ? Oa : Pa.current), (a.context = Ra(e, l))),
					...
					switch (e.tag) {
						case 5:
							...
							return (
								...
								((e.stateNode = n), (Ol = e), (Rl = sa(n.firstChild)), !0)
							);
						case 6:
							return (
								null !== (n = '' === e.pendingProps || 3 !== n.nodeType ? null : n) &&
								((e.stateNode = n), (Ol = e), (Rl = null), !0)
							);
						case 13:
							return (
					...
					if (zl) {
						...
						if (n) {
							...
							if (!Fl(e, n)) {
								...
								n = sa(t.nextSibling);
								var r = Ol;
								n && Fl(e, n) ? Dl(r, t) : ((e.flags = (-4097 & e.flags) | 2), (zl = !1), (Ol = e));
							}
						} else {
							if (Ml(e)) throw Error(l(418));
							(e.flags = (-4097 & e.flags) | 2), (zl = !1), (Ol = e);
						}
					}
				}
				function Il(e) {
				...
				function Al(e) {
					...
					} else Rl = Ol ? sa(e.stateNode.nextSibling) : null;
					return !0;
				}
				function Ul() {
					(Rl = Ol = null), (zl = !1);
				...
				function Po(e, n) {
					...
					if (
						...
						(r = r.queue),
						Ao(Ro.bind(null, t, r, e), [e]),
						r.getSnapshot !== n || o || (null !== po && 1 & po.memoizedState.tag))
					) {
						if (((t.flags |= 2048), Do(9, Oo.bind(null, t, r, a, n), void 0, null), null === _u)) throw Error(l(349));
						0 !== (30 & so) || To(t, n, a);
					}
					return a;
				}
				...
				function $o(e, n, t) {
					return (t = null !== t && void 0 !== t ? t.concat([e]) : null), jo(4, 4, Vo.bind(null, n, e), t);
				}
				function Wo() {}
				function Ho(e, n) {
					var t = Eo();
				...
				var ti = {
					...
					ri = {
						...
						useSyncExternalStore: function (e, n, t) {
							...
							return (
								(a.queue = o),
								Io(Ro.bind(null, r, o, e), [e]),
								(r.flags |= 2048),
								Do(9, Oo.bind(null, r, o, t, n), void 0, null),
								t
							);
						},
						useId: function () {
					...
					switch ((Tl(n), n.tag)) {
						...
						case 6:
							if (e && null != n.stateNode) ci(0, n, e.memoizedProps, r);
								...
								if (((t = Gl(Jl.current)), Gl(Yl.current), Al(n))) {
									if (
										((r = n.stateNode),
										(t = n.memoizedProps),
										(r[da] = n),
										(o = r.nodeValue !== t) && null !== (e = Ol))
									)
										switch (e.tag) {
											case 3:
							...
							return yi(n), null;
						case 13:
							if ((Ca(ro), (r = n.memoizedState), zl && null !== Rl && 0 !== (1 & n.mode) && 0 === (128 & n.flags))) {
							...
							if (null !== r && null !== r.dehydrated) {
								if (((r = Al(n)), null === e)) {
									...
									r[da] = n;
								} else Ul(), 0 === (128 & n.flags) && (n.memoizedState = null), (n.flags |= 4);
								return yi(n), null;
							}
							return (
								...
								0 !== (128 & n.flags)
									...
									: ((r = null !== r),
									  ...
									  r !== t &&
											r &&
											((n.child.flags |= 8192),
											0 !== (1 & n.mode) && (null === e || 0 !== (1 & ro.current) ? 0 === Ru && (Ru = 3) : hs())),
						...
						case 19:
							...
							if (((r = 0 !== (128 & n.flags)), null === (u = o.rendering)))
								if (r) gi(o, !1);
									...
									null !== o.tail && Je() > Au && ((n.flags |= 128), (r = !0), gi(o, !1), (n.lanes = 4194304));
								}
							else {
								if (!r)
									if (null !== (e = ao(u))) {
									...
									if ('style' === c)
										...
										'dangerouslySetInnerHTML' === c
											...
											: 'suppressContentEditableWarning' !== c &&
											  'suppressHydrationWarning' !== c &&
											  (i.hasOwnProperty(c)
													? (null != s && 'onScroll' === c && Ar('scroll', e), o || u === s || (o = []))
													: (o = o || []).push(c, s));
							}
							t && (o = o || []).push('style', t);
							var c = o;
				...
				function _i(e, n, t) {
					...
					if ('hidden' === r.mode)
						if (0 === (1 & n.mode))
							(n.memoizedState = { baseLanes: 0, cachePool: null, transitions: null }), _a(Ou, Tu), (Tu |= t);
						else {
							if (0 === (1073741824 & t))
								return (
					...
					else null !== l ? ((r = l.baseLanes | t), (n.memoizedState = null)) : (r = t), _a(Ou, Tu), (Tu |= r);
				...
				function Ti(e, n, t, r, a) {
					...
					if ((Ga(n, a), null === n.stateNode))
						...
						var u = o.context,
							s = t.contextType;
						'object' === typeof s && null !== s ? (s = Za(s)) : (s = Ra(n, (s = za(t) ? Oa : Pa.current)));
				...
				function zi(e, n, t, r, a) {
					return Ul(), Bl(a), (n.flags |= 256), Si(e, n, t, r), n.child;
				}
					...
					if (null !== (o = e.memoizedState)) {
						...
						return i
							? ((a = Ai(e, n, a.children, a.fallback, t)),
							  ...
							  (n.memoizedState = Li),
							  a)
							: ((t = Ii(e, n, a.children, t)), (n.memoizedState = null), t);
					}
					return i
						? ((a = Ai(e, n, a.children, a.fallback, t)),
						  (i = n.child),
				...
				function Zu(e, n, t) {
					...
					return null === r
						...
						: (yn(r, n, t),
						  (0 !== (2 & Cu) && r === _u) ||
								(r === _u && (0 === (2 & Cu) && (Du |= n), 4 === Ru && os(r, Pu)),
								ts(r, t),
								1 === n && 0 === Cu && 0 === (1 & e.mode) && ((Au = Je() + 500), Aa && Va())),
						  r);
				}
				function es(e, n) {
					e.lanes |= n;
				...
				function rs(e, n) {
					...
					if (0 !== (30 & r) || 0 !== (r & e.expiredLanes) || n) n = ms(e, r);
						...
						Cu |= 2;
						var o = ps();
						for ((_u === e && Pu === n) || ((Uu = null), (Au = Je() + 500), fs(e, n)); ; )
							try {
								gs();
								break;
							} catch (u) {
						...
						Ya(), (Su.current = o), (Cu = a), null !== Nu ? (n = 0) : ((_u = null), (Pu = 0), (n = Ru));
					}
					if (0 !== n) {
						...
						if (6 === n) os(e, r);
							...
							switch (((e.finishedWork = a), (e.finishedLanes = r), n)) {
								...
								case 5:
									...
									break;
								case 3:
									if ((os(e, r), (130023424 & r) === r && 10 < (n = Iu + 500 - Je()))) {
										if (0 !== pn(e, 0)) break;
										if (((a = e.suspendedLanes) & r) !== r) {
											Ju(), (e.pingedLanes |= e.suspendedLanes & a);
											break;
										}
										e.timeoutHandle = ra(ws.bind(null, e, ju, Uu), n);
										break;
									}
									ws(e, ju, Uu);
									break;
								case 4:
									...
									if (
										...
										e.timeoutHandle = ra(ws.bind(null, e, ju, Uu), r);
										break;
									}
									ws(e, ju, Uu);
									break;
				...
				function as(e, n) {
					...
					return (
						...
						2 !== (e = ms(e, n)) && ((n = ju), (ju = t), null !== n && ls(n)),
						e
					);
				}
				function ls(e) {
				...
				function is(e) {
					...
					return (e.finishedWork = e.current.alternate), (e.finishedLanes = n), ws(e, ju, Uu), ts(e, Je()), null;
				}
				function us(e, n) {
					var t = Cu;
					Cu |= 1;
					...
					for (;;) {
						...
						try {
							...
							e: {
								...
								(o = s), 4 !== Ru && (Ru = 2), null === Mu ? (Mu = [o]) : Mu.push(o), (s = oi(s, u)), (u = i);
								do {
									switch (u.tag) {
										case 3:
				...
				function xs(e, n, t) {
					...
					null !== r && r.delete(n),
						...
						_u === e &&
							(Pu & t) === t &&
							(4 === Ru || (3 === Ru && (130023424 & Pu) === Pu && 500 > Je() - Iu) ? fs(e, 0) : (Fu |= t)),
						ts(e, n);
				}
				function Cs(e, n) {
					...
					if (((r = e), 'function' === typeof e)) Rs(e) && (i = 1);
						...
						e: switch (e) {
							...
							case x:
								...
								break;
							case C:
								return ((e = Os(12, t, n, 2 | a)).elementType = C), (e.lanes = o), e;
							case T:
								return ((e = Os(13, t, n, a)).elementType = T), (e.lanes = o), e;
							case O:
								return ((e = Os(19, t, n, a)).elementType = O), (e.lanes = o), e;
							case L:
								return Fs(t, a, o, n);
							default:
				...
				function Fs(e, n, t, r) {
					return ((e = Os(22, e, r, n)).elementType = L), (e.lanes = t), (e.stateNode = {}), e;
				}
				function Ms(e, n, t) {
						...
						switch (e.tag) {
							case 3:
								...
								if (n.current.memoizedState.isDehydrated) {
									...
									0 !== t && (bn(n, 1 | t), ts(n, Je()), 0 === (6 & Cu) && ((Au = Je() + 500), Va()));
								}
								break;
							case 13:
								var r = Ju();
		...
		(function () {
			...
			var l = t(837),
				...
				c = function (e) {
					return (0, i.jsxs)('div', {
						className: 'bet-list',
						children: [(0, i.jsx)('h2', { children: 'Bets go here' }), (0, i.jsx)('ul', {})]
					});
				};
			var f = function () {
					...
					return (
						...
						0 === Object.keys(t).length
							? (0, i.jsx)('div', {
									className: 'App',
									children: (0, i.jsx)('div', { className: 'Bets', children: (0, i.jsx)(c, {}) })
							  })
							: (0, i.jsx)('div', {
									className: 'App',
									children: (0, i.jsx)('div', {
										className: 'ManagedGuilds',
										children: (0, i.jsx)(s, {
											type: 'managed',
											onClick: function (e, n) {
												console.log(n), (window.location.hash = '#guild='.concat(n.id)), r(n);
											}
										})
									})
							  })
			...
			n.createRoot(document.getElementById('root')).render((0, i.jsx)(e.StrictMode, { children: (0, i.jsx)(f, {}) })),
				d();
		})();
})();
//# sourceMappingURL=main.f666ead9.js.map
