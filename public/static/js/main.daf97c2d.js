/*! For license information please see main.daf97c2d.js.LICENSE.txt */
!(function () {
	var e = {
			463: function (e, n, t) {
				'use strict';
				...
				function Be(e, n, t, r, a, l, o, i, u) {
					(Me = !1), (Ie = null), Fe.apply(Ue, arguments);
				}
				function Ve(e) {
					var n = e,
						t = e;
				...
				function $n(e) {
					...
					for (; 0 < Dn.length && null === (t = Dn[0]).blockedOn; ) jn(t), null === t.blockedOn && Dn.shift();
				}
					...
					if (null !== (o = e.memoizedState)) {
						...
						return i
							? ((a = Ai(e, n, a.children, a.fallback, t)),
							  ...
							  (n.memoizedState = Li),
							  a)
							: ((t = ji(e, n, a.children, t)), (n.memoizedState = null), t);
					}
					return i
						? ((a = Ai(e, n, a.children, a.fallback, t)),
						  (i = n.child),
						...
						if (6 === n) os(e, r);
							...
							switch (((e.finishedWork = a), (e.finishedLanes = r), n)) {
								...
								case 5:
									...
									break;
								case 3:
									if ((os(e, r), (130023424 & r) === r && 10 < (n = ju + 500 - Je()))) {
										if (0 !== pn(e, 0)) break;
										if (((a = e.suspendedLanes) & r) !== r) {
											Ju(), (e.pingedLanes |= e.suspendedLanes & a);
											break;
										}
										e.timeoutHandle = ra(ws.bind(null, e, Iu, Uu), n);
										break;
									}
									ws(e, Iu, Uu);
									break;
				...
				function is(e) {
					...
					return (e.finishedWork = e.current.alternate), (e.finishedLanes = n), ws(e, Iu, Uu), ts(e, Je()), null;
				}
				function us(e, n) {
					var t = Cu;
					Cu |= 1;
				...
				function xs(e, n, t) {
					...
					null !== r && r.delete(n),
						...
						_u === e &&
							(Pu & t) === t &&
							(4 === Ou || (3 === Ou && (130023424 & Pu) === Pu && 500 > Je() - ju) ? fs(e, 0) : (Fu |= t)),
						ts(e, n);
				}
				function Cs(e, n) {
		...
		(function () {
			...
			var o = t(837),
				...
				s = function (e) {
					return (0, u.jsxs)('div', {
						...
						children: [
							...
							(0, u.jsx)('span', { className: 'guild-name', children: e.guild.name })
						]
					});
				},
				c = function (n) {
				...
				f = function (e) {
					return (0, u.jsxs)('div', {
						className: 'bet-list',
						children: [(0, u.jsx)('h2', { children: 'Bets go here' }), (0, u.jsx)('ul', {})]
					});
				};
			var d = function () {
					var n = l((0, e.useState)({}), 2),
						...
						r = n[1],
						o = l((0, e.useState)({}), 2);
					if ((o[0], o[1], window.location.hash.startsWith('#'))) {
						var i = window.location.hash.substring(1).split('&');
						console.log(i);
						var s,
							d = (function (e, n) {
						...
						try {
							for (d.s(); !(s = d.n()).done; ) {
								...
								var h = l(p.split('='), 2),
									m = h[0],
									v = h[1];
								console.log(m), console.log(v), 'guild' == m && (t.id = v);
							}
						} catch (g) {
							d.e(g);
						} finally {
					...
					return t.id
						? (0, u.jsx)('div', {
								className: 'App',
								children: (0, u.jsx)('div', { className: 'Bets', children: (0, u.jsx)(f, {}) })
						  })
						: (0, u.jsx)('div', {
								className: 'App',
			...
			n.createRoot(document.getElementById('root')).render((0, u.jsx)(e.StrictMode, { children: (0, u.jsx)(d, {}) })),
				p();
		})();
})();
//# sourceMappingURL=main.daf97c2d.js.map
