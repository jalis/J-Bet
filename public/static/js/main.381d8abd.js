/*! For license information please see main.381d8abd.js.LICENSE.txt */
!(function () {
	var e = {
			463: function (e, n, t) {
				'use strict';
				...
				function rs(e, n) {
					...
					if (0 !== (30 & r) || 0 !== (r & e.expiredLanes) || n) n = ms(e, r);
						...
						Cu |= 2;
						var o = ps();
						for ((_u === e && Nu === n) || ((ju = null), (Uu = Je() + 500), fs(e, n)); ; )
							try {
								gs();
								break;
							} catch (u) {
				...
				function xs(e, n, t) {
					...
					null !== r && r.delete(n),
						...
						_u === e &&
							(Nu & t) === t &&
							(4 === Ou || (3 === Ou && (130023424 & Nu) === Nu && 500 > Je() - Au) ? fs(e, 0) : (Fu |= t)),
						ts(e, n);
				}
				function Cs(e, n) {
	...
	(t.m = e),
		...
		(function () {
			...
			var l = t(837),
				...
				u = function (n) {
					...
					return (
						console.log('test'),
						o()
							.get('/api/user_guilds', { withCredentials: !0 })
							.then(function (e) {
								var n = e.data.map(function (e) {});
								l(n);
							}),
						(0, i.jsx)('ul', { children: r })
					);
				};
			var s = function () {
					return (0, i.jsx)('div', {
						className: 'App',
						children: (0, i.jsx)('div', { className: 'AddGuilds', children: (0, i.jsx)(u, {}) })
					});
				},
				c = function (e) {
					e &&
			...
			n.createRoot(document.getElementById('root')).render((0, i.jsx)(e.StrictMode, { children: (0, i.jsx)(s, {}) })),
				c();
		})();
})();
//# sourceMappingURL=main.381d8abd.js.map
