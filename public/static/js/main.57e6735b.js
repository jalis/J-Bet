/*! For license information please see main.57e6735b.js.LICENSE.txt */
!(function () {
	'use strict';
	var e = {
			463: function (e, n, t) {
				...
				function $n(e, n) {
					e.blockedOn === n &&
						((e.blockedOn = null), Pn || ((Pn = !0), l.unstable_scheduleCallback(l.unstable_NormalPriority, Vn)));
				}
				function Bn(e) {
					function n(n) {
						return $n(n, e);
				...
				function Kn(e, n, t, r) {
					if (Hn) {
						...
						if (null === l) Wr(e, n, r, Yn, t), Dn(e, r);
							...
							for (; null !== l; ) {
								var a = bl(l);
								if ((null !== a && Sn(a), null === (a = Gn(e, n, t, r)) && Wr(e, n, r, Yn, t), a === l)) break;
								l = a;
							}
				...
				function Il(e, n, t) {
					...
					t
						? ((e = Ml(e, n, Ll)), (r.__reactInternalMemoizedMergedChildContext = e), _l(zl), _l(Nl), Cl(Nl, e))
						: _l(zl),
						Cl(zl, t);
				}
				var Ul = null,
				...
				var ga = [],
					...
					_a = '';
				function Ca(e, n) {
					(ga[ya++] = wa), (ga[ya++] = ba), (ba = e), (wa = n);
				}
				function Pa(e, n, t) {
					(ka[Sa++] = Ea), (ka[Sa++] = _a), (ka[Sa++] = xa), (xa = e);
					var r = Ea;
					e = _a;
					var l = 32 - on(r) - 1;
					(r &= ~(1 << l)), (t += 1);
				...
				function za(e) {
					for (; e === ba; ) (ba = ga[--ya]), (ga[ya] = null), (wa = ga[--ya]), (ga[ya] = null);
					for (; e === xa; )
						(xa = ka[--Sa]), (ka[Sa] = null), (_a = ka[--Sa]), (ka[Sa] = null), (Ea = ka[--Sa]), (ka[Sa] = null);
				}
				var La = null,
					Ta = null,
					Oa = !1,
					...
					if (Oa) {
						...
						if (n) {
							...
							if (!Ma(e, n)) {
								...
								n = sl(t.nextSibling);
								var r = La;
								n && Ma(e, n) ? Fa(r, t) : ((e.flags = (-4097 & e.flags) | 2), (Oa = !1), (La = e));
							}
						} else {
							if (Da(e)) throw Error(a(418));
				...
				function Ha(e) {
					...
					function s(e, n, t, r) {
						...
						return a === x
							...
							: null !== n &&
							  (n.elementType === a || ('object' === typeof a && null !== a && a.$$typeof === O && Wa(a) === n.type))
							? (((r = l(n, t.props)).ref = $a(e, n, t)), (r.return = e), r)
							: (((r = Rs(t.type, t.key, t.props, null, e.mode, r)).ref = $a(e, n, t)), (r.return = e), r);
					}
					function c(e, n, t, r) {
						return null === n ||
							4 !== n.tag ||
					...
					function m(l, a, u, i) {
						...
						if (m === u.length) return t(l, f), Oa && Ca(l, m), s;
						if (null === f) {
							for (; m < u.length; m++)
					...
					function v(l, u, i, s) {
						...
						if (y.done) return t(l, m), Oa && Ca(l, v), c;
						if (null === m) {
								...
								case k:
									e: {
										for (var s = o.key, c = a; null !== c; ) {
											if (c.key === s) {
												if ((s = o.type) === x) {
													...
													c.elementType === s ||
													('object' === typeof s && null !== s && s.$$typeof === O && Wa(s) === c.type)
												) {
										...
										o.type === x
											...
											: (((i = Rs(o.type, o.key, o.props, null, r.mode, i)).ref = $a(r, a, o)),
											  (i.return = r),
											  (r = i));
									}
									return u(r);
				...
				function Ja(e, n) {
					switch ((Cl(Xa, n), Cl(Ga, e), Cl(Ya, Ka), (e = n.nodeType))) {
						case 9:
						case 11:
				...
				function wo(e, n, t, r, l, o) {
					if (
						...
						o = 0;
						do {
							if (((mo = !1), (vo = 0), 25 <= o)) throw Error(a(301));
							(o += 1), (po = fo = null), (n.updateQueue = null), (uo.current = au), (e = t(r, l));
						} while (mo);
					}
					if (((uo.current = tu), (n = null !== fo && null !== fo.next), (so = 0), (po = fo = co = null), (ho = !1), n))
						throw Error(a(300));
					return e;
				}
				function ko() {
				...
				function _o(e) {
					...
					if (null !== l) {
						...
						do {
							...
							if ((so & f) === f)
								...
								null === s ? ((i = s = d), (u = r)) : (s = s.next = d), (co.lanes |= f), (Ri |= f);
							}
							c = c.next;
						} while (null !== c && c !== o);
						null === s ? (u = r) : (s.next = i),
					...
					if (null !== (e = t.interleaved)) {
						l = e;
						do {
							(o = l.lane), (co.lanes |= o), (Ri |= o), (l = l.next);
						} while (l !== e);
				...
				function No(e, n) {
					...
					if (
						...
						(r = r.queue),
						jo(To.bind(null, t, r, e), [e]),
						r.getSnapshot !== n || o || (null !== po && 1 & po.memoizedState.tag))
					) {
						if (((t.flags |= 2048), Fo(9, Lo.bind(null, t, r, l, n), void 0, null), null === Ci)) throw Error(a(349));
						0 !== (30 & so) || zo(t, n, l);
					}
					return l;
				}
				...
				function Lo(e, n, t, r) {
					(n.value = t), (n.getSnapshot = r), Oo(n) && Ji(e, 1, -1);
				}
				function To(e, n, t) {
					return t(function () {
						Oo(n) && Ji(e, 1, -1);
				...
				function qo(e, n, t) {
					return 0 === (21 & so)
						...
						: (ur(t, n) || ((t = vn()), (co.lanes |= t), (Ri |= t), (e.baseState = !0)), n);
				}
				function Ko(e, n) {
					var t = wn;
					(wn = 0 !== t && 4 > t ? t : 4), e(!0);
				...
				function Go(e, n, t) {
					...
					(t = { lane: r, action: t, hasEagerState: !1, eagerState: null, next: null }),
						Zo(e) ? Jo(n, t) : (eu(e, n, t), null !== (e = Ji(e, r, (t = Xi()))) && nu(e, n, r));
				}
				function Xo(e, n, t) {
					var r = Zi(e),
				...
				var tu = {
					...
					ru = {
						...
						useImperativeHandle: function (e, n, t) {
							return (t = null !== t && void 0 !== t ? t.concat([e]) : null), Do(4194308, 4, $o.bind(null, n, e), t);
						},
						...
						useSyncExternalStore: function (e, n, t) {
							...
							return (
								(l.queue = o),
								Uo(To.bind(null, r, o, e), [e]),
								(r.flags |= 2048),
								Fo(9, Lo.bind(null, r, o, t, n), void 0, null),
								t
							);
						},
						useId: function () {
					...
					switch ((za(n), n.tag)) {
								...
								(null !== e && null !== e.child) ||
									(ja(n)
										...
										: null === e ||
										  ...
										  ((n.flags |= 1024), null !== Ra && (as(Ra), (Ra = null)))),
								yu(n),
								null
							);
						case 5:
						...
						case 6:
							if (e && null != n.stateNode) cu(0, n, e.memoizedProps, r);
								...
								if (((t = Za(Xa.current)), Za(Ya.current), ja(n))) {
									if (
										((r = n.stateNode),
										(t = n.memoizedProps),
										(r[dl] = n),
										(o = r.nodeValue !== t) && null !== (e = La))
									)
										switch (e.tag) {
											case 3:
							...
							return yu(n), null;
						case 13:
							if ((_l(ro), (r = n.memoizedState), Oa && null !== Ta && 0 !== (1 & n.mode) && 0 === (128 & n.flags))) {
								...
								0 !== (128 & n.flags)
									...
									: ((r = null !== r),
									  ...
									  r !== t &&
											r &&
											((n.child.flags |= 8192),
											0 !== (1 & n.mode) && (null === e || 0 !== (1 & ro.current) ? 0 === Ti && (Ti = 3) : hs())),
						...
						case 10:
							return Gl(n.type._context), yu(n), null;
						case 19:
							...
							if (((r = 0 !== (128 & n.flags)), null === (i = o.rendering)))
								if (r) gu(o, !1);
									...
									null !== o.tail && Xe() > ji && ((n.flags |= 128), (r = !0), gu(o, !1), (n.lanes = 4194304));
								}
							else {
								if (!r)
									if (null !== (e = lo(i))) {
										if (
											...
											gu(o, !0),
											null === o.tail && 'hidden' === o.tailMode && !i.alternate && !Oa)
										)
											return yu(n), null;
									} else
				...
				function xu(e, n, t, r, l) {
					...
					return (
						...
						(t = ko()),
						null === e || ku
							? (Oa && t && Na(n), (n.flags |= 1), Su(e, n, r, l), n.child)
				...
				function Cu(e, n, t) {
					...
					if ('hidden' === r.mode)
						if (0 === (1 & n.mode))
							(n.memoizedState = { baseLanes: 0, cachePool: null, transitions: null }), Cl(Li, zi), (zi |= t);
						else {
							if (0 === (1073741824 & t))
								return (
				...
				function Nu(e, n, t, r, l) {
					...
					return (
						...
						(r = ko()),
						null === e || ku
							? (Oa && r && Na(n), (n.flags |= 1), Su(e, n, t, l), n.child)
							: ((n.updateQueue = e.updateQueue), (n.flags &= -2053), (e.lanes &= ~l), Wu(e, n, l))
					);
				}
				function zu(e, n, t, r, l) {
					...
					if ((Zl(n, l), null === n.stateNode))
						...
						var i = o.context,
							s = t.contextType;
						'object' === typeof s && null !== s ? (s = Jl(s)) : (s = Tl(n, (s = Ol(t) ? Ll : Nl.current)));
					...
					if (null !== (o = e.memoizedState)) {
						if (null !== (r = o.dehydrated)) {
							if (i)
								return 256 & n.flags
									...
									: ((u = l.fallback),
									  (o = n.mode),
									  (l = Ms({ mode: 'visible', children: l.children }, o, 0, null)),
							...
							if (0 === (1 & n.mode)) n = Au(e, n, t, null);
							...
							else if (((l = 0 !== (t & e.childLanes)), ku || l)) {
								if (null !== (l = Ci)) {
									switch (t & -t) {
										case 4:
											u = 2;
								...
								'$?' === r.data
									? ((n.flags |= 128), (n.child = e.child), (n = Cs.bind(null, e)), (r._reactRetry = n), (n = null))
									: ((t = o.treeContext),
									  (Ta = sl(r.nextSibling)),
									  (La = n),
									  (Oa = !0),
									  (Ra = null),
									  null !== t &&
											((ka[Sa++] = Ea), (ka[Sa++] = _a), (ka[Sa++] = xa), (Ea = t.id), (_a = t.overflow), (xa = n)),
						...
						return u
							? ((l = ju(e, n, l.children, l.fallback, t)),
							  ...
							  (u.memoizedState = null === o ? Fu(t) : Mu(o, t)),
				...
				function Iu(e, n) {
					return ((n = Ms({ mode: 'visible', children: n }, e.mode, 0, null)).return = e), (e.child = n);
				}
				function Uu(e, n, t, r) {
					var l = e.child;
					return (
						(e = l.sibling),
						(t = Os(l, { mode: 'visible', children: t })),
				...
				function ju(e, n, t, r, l) {
					...
					return (
						0 === (1 & a) && n.child !== e
							...
							: ((t = Os(e, u)).subtreeFlags = 14680064 & e.subtreeFlags),
						null !== o ? (r = Os(o, r)) : ((r = Fs(r, a, l, null)).flags |= 2),
						(r.return = n),
						(t.return = n),
						(t.sibling = r),
						(n.child = t),
				...
				function Wu(e, n, t) {
					if ((null !== e && (n.dependencies = e.dependencies), (Ri |= n.lanes), 0 === (t & n.childLanes))) return null;
				...
				function Hu(e, n) {
					switch ((za(n), n.tag)) {
						...
						case 4:
							return eo(), null;
						case 10:
							return Gl(n.type._context), null;
						case 22:
						case 23:
							return cs(), null;
						default:
					...
					switch (t.tag) {
						...
						case 6:
							...
							(ui = null),
								...
								null !== (ui = r) &&
									(ii
										? ((e = ui), (t = t.stateNode), 8 === e.nodeType ? e.parentNode.removeChild(t) : e.removeChild(t))
						...
						case 15:
							...
							break;
						case 1:
							if (!qu && (Gu(t, n), 'function' === typeof (r = t.stateNode).componentWillUnmount))
								try {
				...
				function pi(e, n) {
					...
					switch (e.tag) {
						...
						case 15:
							...
							break;
						case 1:
							di(n, e), hi(e), 512 & r && null !== t && Gu(t, t.return);
							break;
						case 5:
							if ((di(n, e), hi(e), 512 & r && null !== t && Gu(t, t.return), 32 & e.flags)) {
								var l = e.stateNode;
								try {
									de(l, '');
								} catch (m) {
						...
						case 6:
							...
							break;
						case 3:
							if ((di(n, e), hi(e), 4 & r && null !== t && t.memoizedState.isDehydrated))
								try {
									Bn(n.containerInfo);
								} catch (m) {
									xs(e, e.return, m);
										...
										for (c = Yu = e; null !== Yu; ) {
											switch (((d = (f = Yu).child), f.tag)) {
												...
												case 15:
													...
													break;
												case 1:
													if ((Gu(f, f.return), 'function' === typeof (o = f.stateNode).componentWillUnmount)) {
														(p = f), (h = f.return);
														try {
															(l = p),
				...
				var wi,
					...
					Gi = 0;
				function Xi() {
					return 0 !== (6 & _i) ? Xe() : -1 !== Yi ? Yi : (Yi = Xe());
				}
				function Zi(e) {
					return 0 === (1 & e.mode)
						? 1
				...
				function Ji(e, n, t) {
					...
					return null === r
						...
						: (yn(r, n, t),
						  (0 !== (2 & _i) && r === Ci) ||
								(r === Ci && (0 === (2 & _i) && (Fi |= n), 4 === Ti && os(r, Ni)),
								ts(r, t),
								1 === n && 0 === _i && 0 === (1 & e.mode) && ((ji = Xe() + 500), jl && $l())),
						  r);
				}
				function es(e, n) {
					e.lanes |= n;
				...
				function rs(e, n) {
					if (((Yi = -1), (Gi = 0), 0 !== (6 & _i))) throw Error(a(327));
					var t = e.callbackNode;
					...
					if (0 !== (30 & r) || 0 !== (r & e.expiredLanes) || n) n = ms(e, r);
						...
						_i |= 2;
						var o = ps();
						for ((Ci === e && Ni === n) || ((Ai = null), (ji = Xe() + 500), fs(e, n)); ; )
							try {
								gs();
								break;
							} catch (i) {
					...
					if (0 !== n) {
						if ((2 === n && 0 !== (l = mn(e)) && ((r = l), (n = ls(e, l))), 1 === n))
							throw ((t = Oi), fs(e, 0), os(e, r), ts(e, Xe()), t);
						if (6 === n) os(e, r);
						else {
							if (
								...
								0 === (30 & r) &&
									...
									(2 === (n = ms(e, r)) && 0 !== (o = mn(e)) && ((r = o), (n = ls(e, o))), 1 === n))
							)
								throw ((t = Oi), fs(e, 0), os(e, r), ts(e, Xe()), t);
							switch (((e.finishedWork = l), (e.finishedLanes = r), n)) {
								...
								case 5:
									...
									break;
								case 3:
									if ((os(e, r), (130023424 & r) === r && 10 < (n = Ui + 500 - Xe()))) {
										if (0 !== pn(e, 0)) break;
										if (((l = e.suspendedLanes) & r) !== r) {
											Xi(), (e.pingedLanes |= e.suspendedLanes & l);
											break;
										}
										e.timeoutHandle = rl(ws.bind(null, e, Ii, Ai), n);
										break;
									}
									ws(e, Ii, Ai);
									break;
								case 4:
									...
									if (
										...
										e.timeoutHandle = rl(ws.bind(null, e, Ii, Ai), r);
										break;
									}
									ws(e, Ii, Ai);
									break;
				...
				function os(e, n) {
					for (n &= ~Mi, n &= ~Fi, e.suspendedLanes |= n, e.pingedLanes &= ~n, e = e.expirationTimes; 0 < n; ) {
						var t = 31 - on(n),
							r = 1 << t;
						(e[t] = -1), (n &= ~r);
					}
				...
				function us(e) {
					...
					if (1 === t) throw ((t = Oi), fs(e, 0), os(e, n), ts(e, Xe()), t);
					if (6 === t) throw Error(a(345));
					return (e.finishedWork = e.current.alternate), (e.finishedLanes = n), ws(e, Ii, Ai), ts(e, Xe()), null;
				}
				function is(e, n) {
					var t = _i;
					_i |= 1;
					try {
						...
						0 === (_i = t) && ((ji = Xe() + 500), jl && $l());
					}
				}
				function ss(e) {
					null !== Hi && 0 === Hi.tag && 0 === (6 & _i) && ks();
					var n = _i;
					_i |= 1;
					var t = Ei.transition,
						r = wn;
					try {
						...
						(wn = r), (Ei.transition = t), 0 === (6 & (_i = n)) && $l();
					}
				}
				function cs() {
					(zi = Li.current), _l(Li);
						...
						try {
							...
							e: {
								var o = e,
									...
									s = n;
								if (
									((n = Ni), (i.flags |= 32768), null !== s && 'object' === typeof s && 'function' === typeof s.then)
								) {
									var c = s,
										f = i,
										d = f.tag;
									...
									var h = mu(u);
									if (null !== h) {
										(h.flags &= -257), vu(h, u, i, 0, n), 1 & h.mode && hu(o, c, n), (s = c);
								...
								(o = s), 4 !== Ti && (Ti = 2), null === Di ? (Di = [o]) : Di.push(o), (s = ou(s, i)), (i = u);
								do {
									switch (i.tag) {
										case 3:
										...
										case 1:
											...
											if (
												...
												('function' === typeof y.getDerivedStateFromError ||
													(null !== b && 'function' === typeof b.componentDidCatch && (null === Bi || !Bi.has(b))))
											) {
				...
				function hs() {
					(0 !== Ti && 3 !== Ti && 2 !== Ti) || (Ti = 4),
						null === Ci || (0 === (268435455 & Ri) && 0 === (268435455 & Fi)) || os(Ci, Ni);
				}
				function ms(e, n) {
					var t = _i;
					_i |= 2;
				...
				function ks() {
					if (null !== Hi) {
						var e = kn(Qi),
							...
							t = wn;
						try {
							if (((Ei.transition = null), (wn = 16 > e ? 16 : e), null === Hi)) var r = !1;
							else {
								...
								if (((_i = l), $l(), an && 'function' === typeof an.onPostCommitFiberRoot))
									try {
				...
				function Ss(e, n, t) {
					aa(e, (n = du(0, (n = ou(t, n)), 1))), (n = Xi()), null !== (e = es(e, 1)) && (yn(e, 1, n), ts(e, n));
				}
				function xs(e, n, t) {
					if (3 === e.tag) Ss(e, e, t);
					else
						for (; null !== n; ) {
							...
							if (1 === n.tag) {
								...
								if (
									...
									aa(n, (e = pu(n, (e = ou(t, e)), 1))), (e = Xi()), null !== (n = es(n, 1)) && (yn(n, 1, e), ts(n, e));
									break;
								}
							}
							n = n.return;
				...
				function Es(e, n, t) {
					...
					null !== r && r.delete(n),
						...
						Ci === e &&
							(Ni & t) === t &&
							(4 === Ti || (3 === Ti && (130023424 & Ni) === Ni && 500 > Xe() - Ui) ? fs(e, 0) : (Mi |= t)),
						ts(e, n);
				}
				function _s(e, n) {
				...
				function Ms(e, n, t, r) {
					return ((e = Ls(22, e, r, n)).elementType = R), (e.lanes = t), (e.stateNode = {}), e;
				}
				function Ds(e, n, t) {
				...
				function $s(e, n, t, r, l, a, o, u, i) {
					return (
						...
						(t = e.current),
						((a = la((r = Xi()), (l = Zi(t)))).callback = void 0 !== n && null !== n ? n : null),
						aa(t, a),
						(e.current.lanes = l),
						yn(e, l, r),
						ts(e, r),
											...
											case 13:
												if (null !== (r = n.memoizedState))
													return null !== r.dehydrated
														...
														? Du(e, n, t)
														: (Cl(ro, 1 & ro.current), null !== (e = Wu(e, n, t)) ? e.sibling : null);
												Cl(ro, 1 & ro.current);
												break;
											case 19:
							...
							return (
								...
								'object' === typeof l && null !== l && 'function' === typeof l.render && void 0 === l.$$typeof
									? ((n.tag = 1),
									  ...
									  va(n, r, e, t),
									  (n = Lu(null, n, r, !0, o, t)))
									: ((n.tag = 0), Oa && o && Na(n), Su(null, n, l, t), (n = n.child)),
								n
							);
						case 16:
							r = n.elementType;
							...
							e: {
								...
								if (((r = u.element), o.isDehydrated)) {
									if (
										...
										n = Ou(e, n, r, t, (l = Error(a(423))));
										break e;
									}
									if (r !== l) {
										n = Ou(e, n, r, t, (l = Error(a(424))));
										break e;
									}
									for (
									...
									if (ur(o.value, u)) {
										...
										for (null !== (o = n.child) && (o.return = n); null !== o; ) {
											...
											if (null !== i) {
												...
												(u.lanes |= t), null !== (i = u.alternate) && (i.lanes |= t), Xl(u, t, n), (u = o.sibling);
											} else u = o.child;
					...
					if (a) {
						...
						o = (function (e, n, t, r, l) {
							if (l) {
								...
								return (
									(e._reactRootContainer = o), (e[hl] = o.current), $r(8 === e.nodeType ? e.parentNode : e), ss(), o
								);
							}
				...
				(Ys.prototype.render = Ks.prototype.render =
						...
						switch (e.tag) {
							case 3:
								...
								if (n.current.memoizedState.isDehydrated) {
									...
									0 !== t && (bn(n, 1 | t), ts(n, Xe()), 0 === (6 & _i) && ((ji = Xe() + 500), $l()));
								}
								break;
							case 13:
								var r = Xi();
					...
					(Ne = is),
					(ze = ss);
				var ec = { usingClientEntryPoint: !1, Events: [bl, wl, kl, Ce, Pe, is] },
					...
					(n.unstable_scheduleCallback = function (e, l, a) {
						...
						return (
							...
							a > o
								? ((e.sortIndex = a),
								  t(c, e),
								  null === r(s) && e === r(c) && (v ? (y(C), (C = -1)) : (v = !0), F(k, a - o)))
		...
		(function () {
			...
			function l() {
						...
						(a._invoke = (function (e, n, t) {
							...
							return function (l, a) {
								...
								for (t.method = l, t.arg = a; ; ) {
									...
									var i = f(e, n, t);
									if ('normal' === i.type) {
										if (((r = t.done ? 'completed' : 'suspendedYield'), i.arg === d)) continue;
										return { value: i.arg, done: t.done };
									}
									'throw' === i.type && ((r = 'completed'), (t.method = 'throw'), (t.arg = i.arg));
								}
							};
						})(e, t, o)),
						a
				...
				function S(e, n) {
					...
					if (void 0 === t) {
						if (((n.delegate = null), 'throw' === n.method)) {
							if (e.iterator.return && ((n.method = 'return'), (n.arg = void 0), S(e, n), 'throw' === n.method))
								return d;
				...
				return (
					...
					(e.mark = function (e) {
						return (
							Object.setPrototypeOf ? Object.setPrototypeOf(e, m) : ((e.__proto__ = m), s(e, i, 'GeneratorFunction')),
					...
					(_.prototype = {
						...
						abrupt: function (e, n) {
							...
							return (
								(o.type = e),
								(o.arg = n),
								a ? ((this.method = 'next'), (this.next = a.finallyLoc), d) : this.complete(o)
							);
						},
								...
								return l().wrap(function (e) {
									for (;;)
										switch ((e.prev = e.next)) {
											case 0:
												return (e.next = 2), fetch('/api/user_guilds');
											case 2:
											...
											case 5:
												return (
													(r = e.sent),
													(a = r.map(function (e) {})),
													e.abrupt('return', (0, o.jsx)('ul', { children: a }))
												);
											case 8:
											case 'end':
												return e.stop();
			...
			var i = function () {
					return (0, o.jsx)('div', {
						className: 'App',
						children: (0, o.jsx)('div', { className: 'AddGuilds', children: (0, o.jsx)(u, {}) })
					});
				},
				s = function (e) {
					e &&
			...
			n.createRoot(document.getElementById('root')).render((0, o.jsx)(e.StrictMode, { children: (0, o.jsx)(i, {}) })),
				s();
		})();
})();
//# sourceMappingURL=main.57e6735b.js.map
