/*! For license information please see main.6a742380.js.LICENSE.txt */
!(function () {
	'use strict';
	var e = {
			463: function (e, n, t) {
				...
				function Il(e, n, t) {
					...
					t
						? ((e = Fl(e, n, Tl)), (r.__reactInternalMemoizedMergedChildContext = e), Cl(zl), Cl(Nl), _l(Nl, e))
						: Cl(zl),
						_l(zl, t);
				}
				var Ul = null,
					...
					if (Ra) {
						...
						if (n) {
							...
							if (!Fa(e, n)) {
								...
								n = sl(t.nextSibling);
								var r = Ta;
								n && Fa(e, n) ? Ma(r, t) : ((e.flags = (-4097 & e.flags) | 2), (Ra = !1), (Ta = e));
							}
						} else {
							if (Da(e)) throw Error(a(418));
				...
				function Wa(e) {
					...
					function s(e, n, t, r) {
						...
						return a === x
							...
							: null !== n &&
							  (n.elementType === a || ('object' === typeof a && null !== a && a.$$typeof === R && Ha(a) === n.type))
							? (((r = l(n, t.props)).ref = $a(e, n, t)), (r.return = e), r)
							: (((r = Os(t.type, t.key, t.props, null, e.mode, r)).ref = $a(e, n, t)), (r.return = e), r);
					}
					function c(e, n, t, r) {
						return null === n ||
							4 !== n.tag ||
					...
					function d(e, n, t) {
						...
						if ('object' === typeof n && null !== n) {
							switch (n.$$typeof) {
								case w:
									return ((t = Os(n.type, n.key, n.props, null, e.mode, t)).ref = $a(e, null, n)), (t.return = e), t;
								case S:
									return ((n = Is(n, e.mode, t)).return = e), n;
								case R:
									return d(e, (0, n._init)(n._payload), t);
							}
							if (ne(n) || F(n)) return ((n = Ms(n, e.mode, t, null)).return = e), n;
							Ba(e, n);
						}
						return null;
					}
							...
							switch (o.$$typeof) {
								case w:
									e: {
										...
										o.type === x
											? (((a = Ms(o.props.children, r.mode, i, o.key)).return = r), (r = a))
											: (((i = Os(o.type, o.key, o.props, null, r.mode, i)).ref = $a(r, a, o)),
											  (i.return = r),
											  (r = i));
									}
									return u(r);
					...
					if (null !== l) {
						...
						do {
							...
							if ((so & f) === f)
								...
								null === s ? ((i = s = d), (u = r)) : (s = s.next = d), (co.lanes |= f), (Oi |= f);
							}
							c = c.next;
						} while (null !== c && c !== o);
						null === s ? (u = r) : (s.next = i),
				...
				function No(e, n) {
					...
					if (
						...
						if (((t.flags |= 2048), Mo(9, To.bind(null, t, r, l, n), void 0, null), null === _i)) throw Error(a(349));
						0 !== (30 & so) || zo(t, n, l);
					}
					return l;
				}
				...
				function Do(e, n, t, r) {
					var l = So();
					(co.flags |= e), (l.memoizedState = Mo(1 | n, t, void 0, void 0 === r ? null : r));
				}
				function Io(e, n, t, r) {
					var l = xo();
					r = void 0 === r ? null : r;
					...
					if (null !== fo) {
						...
						if (((a = o.destroy), null !== r && bo(r, o.deps))) return void (l.memoizedState = Mo(n, t, a, r));
					}
				...
				function qo(e, n, t) {
					return 0 === (21 & so)
						...
						: (ur(t, n) || ((t = vn()), (co.lanes |= t), (Oi |= t), (e.baseState = !0)), n);
				}
				function Ko(e, n) {
					var t = kn;
					(kn = 0 !== t && 4 > t ? t : 4), e(!0);
				...
				function bu(e, n, t) {
					...
					switch ((za(n), n.tag)) {
								...
								(null !== e && null !== e.child) ||
									(ja(n)
										...
										: null === e ||
										  ...
										  ((n.flags |= 1024), null !== Oa && (as(Oa), (Oa = null)))),
								yu(n),
								null
							);
						case 5:
						...
						case 6:
							...
							return yu(n), null;
						case 13:
							if ((Cl(ro), (r = n.memoizedState), Ra && null !== La && 0 !== (1 & n.mode) && 0 === (128 & n.flags))) {
						...
						case 19:
							...
							if (((r = 0 !== (128 & n.flags)), null === (i = o.rendering)))
								if (r) gu(o, !1);
									...
									null !== o.tail && Ge() > ji && ((n.flags |= 128), (r = !0), gu(o, !1), (n.lanes = 4194304));
								}
							else {
								if (!r)
									if (null !== (e = lo(i))) {
						...
						if (null !== (r = o.dehydrated)) {
							if (i)
								return 256 & n.flags
									...
									: ((u = l.fallback),
									  (o = n.mode),
									  (l = Fs({ mode: 'visible', children: l.children }, o, 0, null)),
							...
							if (0 === (1 & n.mode)) n = Au(e, n, t, null);
								...
								'$?' === r.data
									...
									: ((t = o.treeContext),
									  ...
									  (Oa = null),
									  null !== t &&
											((wa[Sa++] = Ea), (wa[Sa++] = Ca), (wa[Sa++] = xa), (Ea = t.id), (Ca = t.overflow), (xa = n)),
				...
				function Ji(e, n, t) {
					...
					return null === r
						...
						: (yn(r, n, t),
						  (0 !== (2 & Ci) && r === _i) ||
								(r === _i && (0 === (2 & Ci) && (Mi |= n), 4 === Li && os(r, Ni)),
								ts(r, t),
								1 === n && 0 === Ci && 0 === (1 & e.mode) && ((ji = Ge() + 500), jl && $l())),
						  r);
				}
				function es(e, n) {
					e.lanes |= n;
				...
				function rs(e, n) {
					...
					if (0 !== (30 & r) || 0 !== (r & e.expiredLanes) || n) n = hs(e, r);
						...
						Ci |= 2;
						var o = ps();
						for ((_i === e && Ni === n) || ((Ai = null), (ji = Ge() + 500), fs(e, n)); ; )
							try {
								gs();
								break;
							} catch (i) {
						...
						Yl(), (Si.current = o), (Ci = l), null !== Pi ? (n = 0) : ((_i = null), (Ni = 0), (n = Li));
					}
					if (0 !== n) {
				...
				function us(e) {
					...
					return (e.finishedWork = e.current.alternate), (e.finishedLanes = n), ks(e, Ii, Ai), ts(e, Ge()), null;
				}
				function is(e, n) {
					var t = Ci;
					Ci |= 1;
					try {
						...
						0 === (Ci = t) && ((ji = Ge() + 500), jl && $l());
					}
				}
				function ss(e) {
					null !== Wi && 0 === Wi.tag && 0 === (6 & Ci) && ws();
					var n = Ci;
					Ci |= 1;
					var t = Ei.transition,
						r = kn;
					...
					for (;;) {
						...
						try {
							...
							e: {
								...
								(o = s), 4 !== Li && (Li = 2), null === Di ? (Di = [o]) : Di.push(o), (s = ou(s, i)), (i = u);
								do {
									switch (i.tag) {
										case 3:
				...
				function ms() {
					(0 !== Li && 3 !== Li && 2 !== Li) || (Li = 4),
						null === _i || (0 === (268435455 & Oi) && 0 === (268435455 & Mi)) || os(_i, Ni);
				}
				function hs(e, n) {
					var t = Ci;
					Ci |= 2;
					...
					if ((Yl(), (Ci = t), (Si.current = r), null !== Pi)) throw Error(a(261));
								...
								if (
									...
									(Ci |= 4),
										...
										(function (e, n) {
											...
											for (nl = { focusedElem: e, selectionRange: t }, Wn = !1, Yu = n; null !== Yu; )
					...
					if (null !== Wi) {
						...
						try {
							if (((Ei.transition = null), (kn = 16 > e ? 16 : e), null === Wi)) var r = !1;
								...
								if (((e = Wi), (Wi = null), (Qi = 0), 0 !== (6 & Ci))) throw Error(a(331));
								var l = Ci;
				...
				function Es(e, n, t) {
					...
					null !== r && r.delete(n),
						...
						_i === e &&
							(Ni & t) === t &&
							(4 === Li || (3 === Li && (130023424 & Ni) === Ni && 500 > Ge() - Ui) ? fs(e, 0) : (Fi |= t)),
						ts(e, n);
				}
				function Cs(e, n) {
				...
				function Fs(e, n, t, r) {
					return ((e = Ts(22, e, r, n)).elementType = O), (e.lanes = t), (e.stateNode = {}), e;
				}
				function Ds(e, n, t) {
				...
				ki = function (e, n, t) {
											...
											case 13:
												if (null !== (r = n.memoizedState))
													return null !== r.dehydrated
														...
														? Du(e, n, t)
														: (_l(ro, 1 & ro.current), null !== (e = Hu(e, n, t)) ? e.sibling : null);
												_l(ro, 1 & ro.current);
												break;
											case 19:
					...
					switch (((n.lanes = 0), n.tag)) {
							...
							return (
								...
								'object' === typeof l && null !== l && 'function' === typeof l.render && void 0 === l.$$typeof
									? ((n.tag = 1),
									  ...
									  va(n, r, e, t),
									  (n = Tu(null, n, r, !0, o, t)))
									: ((n.tag = 0), Ra && o && Na(n), Su(null, n, l, t), (n = n.child)),
								n
							);
						case 16:
							r = n.elementType;
							...
							return n;
						case 0:
							return (r = n.type), (l = n.pendingProps), Nu(e, n, r, (l = n.elementType === r ? l : Hl(r, l)), t);
						case 1:
							return (r = n.type), (l = n.pendingProps), zu(e, n, r, (l = n.elementType === r ? l : Hl(r, l)), t);
						case 3:
							e: {
						...
						case 11:
							return (r = n.type), (l = n.pendingProps), xu(e, n, r, (l = n.elementType === r ? l : Hl(r, l)), t);
						case 7:
						...
						case 14:
							return (l = Hl((r = n.type), n.pendingProps)), Eu(e, n, r, (l = Hl(r.type, l)), t);
						case 15:
					...
					if (a) {
						...
						o = (function (e, n, t, r, l) {
							if (l) {
								...
								return (
									(e._reactRootContainer = o), (e[ml] = o.current), $r(8 === e.nodeType ? e.parentNode : e), ss(), o
								);
							}
						...
						switch (e.tag) {
							case 3:
								...
								if (n.current.memoizedState.isDehydrated) {
									...
									0 !== t && (bn(n, 1 | t), ts(n, Ge()), 0 === (6 & Ci) && ((ji = Ge() + 500), $l()));
								}
								break;
							case 13:
								var r = Gi();
	...
	(t.m = e),
		...
		(function () {
			...
			var l = function () {
					return (0, r.jsx)('div', {
						className: 'App',
						children: (0, r.jsx)('div', { className: 'AddGuilds', children: (0, r.jsx)('span', { children: 'Hi' }) })
					});
				},
				a = function (e) {
					e &&
			...
			n.createRoot(document.getElementById('root')).render((0, r.jsx)(e.StrictMode, { children: (0, r.jsx)(l, {}) })),
				a();
		})();
})();
//# sourceMappingURL=main.6a742380.js.map
